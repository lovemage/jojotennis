...
export default function HomePageContent() {
  ...
  const features = [
    { title: "🗺 找球場", description: "全台球場即時查詢", href: "/courts" },
    {
      title: "🎾 揪球友",
      description: `今日 ${openMatches} 場開放中`,
      href: "/match",
    },
    { title: "🎓 找教練", description: "依等級媒合教練", href: "/coach" },
    { title: "📰 網球新聞", description: "最新賽事資訊", href: "/news" },
  ];
        ...
        <div className="mt-4 space-y-3">
          {matches.slice(0, 3).map((match) => (
            ...
            >
              ...
              <h3 className="mt-1 font-bold text-pine">{match.title}</h3>
        ...
        <div className="mt-4 flex gap-4 overflow-x-auto pb-2">
          {publishedNews.slice(0, 3).map((article) => (
            ...
            >
              ...
              <h3 className="mt-2 line-clamp-2 font-bold text-pine">{article.title}</h3>
...
function HeroSection({
  ...
  features: Array<{ title: string; description: string; href: string }>;
}) {
  return (
    <>
